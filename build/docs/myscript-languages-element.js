...
`;
  ...
  _buildConfiguration() {
    return MyScriptLanguagesElement._generateConfiguration(this.configuration, this.language, this.triggerdelay, this.processdelay, this.type, this.protocol, this.apiversion, this.scheme, this.host, this.applicationkey, this.hmackey);
  }
  ...
  _getLanguages() {
    ...
    this.languages = Object.keys(res.result).map(key => ({
      value: key,
